...
[Successful apps nail these 12 Things ACCURATELY](https://x.com/Hartdrawss/status/2029217957537006015)
...
→ Clean bio that explains your app

Days 1–7
→ Warm up the account
→ Scroll only in your niche
→ Like, comment, follow
→ Save viral videos
→ DO NOT POST
...
→ Recreate proven viral formats
→ Focus on watch time + comments
→ Soft CTA for your app
